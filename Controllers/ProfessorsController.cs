...
namespace GestaoTarefas_CP.Controllers
{
    public class ProfessorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProfessorId,Nome,Telemóvel,Email,Gabinete,Disciplina")] Professor professor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("ProfessorId,Nome,Telemovel,Email,Gabinete,Disciplina")] Professor professor)
        {
